...
function normalizeCourse(course) {
  ...
  if (Array.isArray(course.courseEquivalents)) {
    return {
      anyOf: _toConsumableArray(course.courseEquivalents)
    };
  }
...
function normalizePrerequisites(prereqs) {
  var type = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'allOf';
  var normalized = prereqs.map(normalizeCourse);
  if (normalized.length === 1) return normalized[0];
  return _defineProperty({}, type, normalized);
}
...
var prerequisiteData = {
  majors: {
    "computer_science": [{
      ...
      "prerequisites": ["For CISC 1115, a student must not receive credit for CISC 1110 (Introduction to Programming using C++). Otherwise if they receive credit for CISC 1110 they must take CISC 1170"]
    }, {
      "id": 2,
      ...
      "prerequisites": ["If a student wishes to take CISC 3220 or CISC 3230 they need to pass both CISC 2210 and CISC 3130 with a C or higher"]
    }, {
      "id": 4,
      ...
      "prerequisites": ["If a student wishes to take CISC 4900 they must take pass CISC 3130 and advanced elective between CISC 3000-4899 a C or higher. However, if a student wishes to take CISC 5001 they must pass CISC 3130 with a C or higher and a GPA of a 3.0 in CIS courses, and permission of the chairperson"]
    }, {
      "id": 5,
      ...
      "prerequisites": ["If a student wishes to take CISC 2820W or PHIL 3318W they must complete CISC 1115 or CISC 1110 with a C or higher and ENGL 1012 with a C or higher"]
    }, {
      "id": 6,
      "name": "Calculus I and Calculus II",
      "options": ["Calculus I", "Calculus II"],
      "requirements": ["MATH 1201", "MATH 1206"],
      "prerequisites": ["If a student wishes to take MATH 1201 they must complete MATH 1101 with a C- or higher. Also, if a student wishes to take MATH 1206 they must complete MATH 1201 with a C- or higher."]
    }, {
      "id": 7,
      ...
      "prerequisites": ["If a student wishes to take MATH 2501 or MATH 3501 they must pass MATh 1206 with a C- or higher"]
    }, {
      "id": 8,
      ...
      "prerequisites": ["If a student wishes to take an advanced CISC course elective such as CISC 3000-4899 they must complete CISC 3115 or CISC 3110 and CISC 3130 with a C or higher"]
    }],
    ...
    "multimedia_computing": [{
      ...
      "options": ["Independent Group and Study I", "Research and Study I"],
      "requirements": ["CISC 4900", "CISC 5001"],
      "prerequisites": ["If a student wishes to take CISC 4900 they must take pass CISC 3130 and advanced elective between CISC 3000-4899 a C or higher. However, if a student wishes to takes CISC 5001 they must pass CISC 3130 with a C or higher and a GPA of a 3.0 in CIS courses, and permission of the chairperson"]
    }, {
      "id": 4,
      "name": 'Calculus I',
      "options": ['Calculus I'],
      "requirements": ['MATH 1201'],
      "prerequisites": ['If a student wishes to take MATH 1201 they must pass MATH 1101 with a C- or higher']
    }, {
      "id": 5,
      "name": 'Calculus II',
      "options": ['Calculus II'],
      "requirements": ['MATH 1206'],
      "prerequisites": ['If a student wishes to take MATH 1206 they must pass MATH 1201 with a C- or higher']
    }, {
      "id": 6,
      "name": 'Elementary Probability and Statistics I',
      "options": ['Elementary Probability and Statistics I'],
      "requirements": ['MATH 2501'],
      "prerequisites": ['If a student wishes to take MATH 2501 they must pass MATH 1206 with a C- or higher']
    }, {
      "id": 7,
      ...
      "prerequisites": ['If a student wishs to take CISC 3650 they must pass CISC 3115 or CISC 3110 with a C or higher. Otherwise, if they wish to take CISC 3667 they must CISC 3130 with a C or higher.']
    }, {
      "id": 8,
      ...
      "prerequisites": ['Depending on which elective class you are pursuing please consult the proper major department in understanding the prerequsites for the suggested electives. Visit this link here: https://www.brooklyn.edu/academics/programs/']
    }],
    ...
    "information_systems": [{
      ...
      "prerequisites": ['For CISC 3115, a student must have not receive credit for CISC 3110 (Advanced Programming Techniques). As for CISC 3130 a student must pass CISC 1115 or CISC 1110 for a C or higher. Lastly, for CISC 3810 a student must pass CISC 3130 for a C or higher.']
    }, {
      "id": 3,
      "name": "Independent Group and Study I or Research and Study I",
      "options": ["Independent Group and Study I", "Research and Study I"],
      ...
      "prerequisites": ["A student is required to take CISC 1050 if they are unfamiliar with PC application software"]
    }, {
      "id": 5,
      ...
      "prerequisites": ['If a student wishes to take CISC 3140, CISC 3171, or CISC 3410 they must pass CISC 3130 with a C or higher. If they wish to take CISC 3340 they must pass CISC 3130 with a C or higher and MATH 2501 with a C- or higher']
    }, {
      "id": 6,
      ...
      "prerequisites": ["If a student wishes to take CISC 1590 or BUSN 3420 they must pass CISC 1050 with a C or higher"]
    }, {
      "id": 9,
      ...
      "prerequisites": ["If a student wishes to take CISC 1530 or BUSN 3120 they must pass CISC 1050, CISC 1110, CICS 1115 with a C or better. However, if they wish to take CISC 2532 or BUSN 2432 they must pass CISC 1590 or BUSN 3420 with a C or better"]
    }, {
      "id": 10,
      ...
      "prerequisites": ["If a student wishes to take BUSN 4202W or CISC 1580W they must pass ENGL 1012 and BUSN 3200 with a C or better."]
    }, {
      "id": 11,
      ...
      "requirements": ['FIN 3310'],
      "prerequisites": ['If a student wishes to take FINC 3310 they must pass Accounting 2001, Economics 2100, Economics 2200, and Business 3400 or Economics 3400 with a C or better']
    }, {
      "id": 13,
      "name": 'Principles of Accounting I (Financial)',
      "options": ['Principles of Accounting I (Financial)'],
      "requirements": ['ACCT 2001'],
      "prerequisites": ['If a student wishes to take ACCT 2001 they must not pass prior equivalent courses. They should speak with an advisor to confirm if eligible for this course']
    }, {
      "id": 14,
      ...
      "requirements": ['BUSN 3400', 'ECON 3400', 'MATH 2501', 'MATH 3501', 'PYSCH 3400'],
      "prerequisites": ['If a student wishes to take BUSN 3400/ECON 3400 or MATH 2501/MATH 3501 they must pass MATH 1101 with a C- or better. However, if they wish to take PYSCH 3400 they must pass PYSCH 1000 with a C- or better']
    }, {
      "id": 15,
  ...
  minors: {
    "computer_science": [{
      ...
      "requirements": ["CISC 1115 or CISC 1110", "CISC 1050", "CISC 2531", "CISC 2210", "CISC 3110 or CISC 3115", "CISC 3130", "CISC 3630"],
      ...
      "requirements": ["CISC 1115 or CISC 1110", "CISC 3110 or CISC 3115", "CISC 3130", "Two additional courses numbered 2000 or above"],
    ...
    "multimedia_computing": [{
      ...
      "prerequisites": ["CISC 1115 or CISC 1170"]
    }, {
      "id": 4,
      "name": "Data Structures",
      "options": ["Data Structures"],
      "requirements": ["CISC 3130"],
      "prerequisites": ["CISC 1115 or CISC 1170 and CISC 3115 or CISC 3110"]
    }, {
      "id": 5,
      ...
      "prerequisites": ["Most of these courses except CISC 3650 require CISC 3130 with a grade C or higher, for CISC 3650 you need to pass CISC 3115 or CISC 3110 with a C or higher"]
    }],
    "cognitive_science": [{
      "id": 1,
      ...
      "prerequisites": ["If a student wishes to take CISC 1115 they must not receive credit for CISC 1110 (Introduction to Programming using C++)"]
    }, {
      "id": 3,
      ...
      "requirements": ["PYSCH 1000", "PYSCH 3530"],
      "prerequisites": ["If a student wishes to take PYSCH 3530 they must pass PYSCH 1000 with a C or higher"]
    }, {
      "id": 4,
      ...
      "prerequisites": ["Some of these classes may have a prerequisite of passing a prior philosophy with a C or higher"]
    }, {
      "id": 5,
    ...
    "data_science": [{
      ...
      "prerequisites": ["If a student wishes to take CISC 32250 they must pass CISC 1215 and CISC 2210 with a C or higher. As for CISC 3440 they must pass CISC 3130 with a C or higher"]
    }, {
      "id": 2,
      "name": "Applied Intermediate Statistics",
      "options": ["Applied Intermediate Statistics"],
      "requirements": ["MATH 4531"],
      "prerequisites": ["If a student wishes to take MATH 4531 they must pass MATH 2501 or MATH 3501 and MATH 2101 with a C or higher"]
    }, {
      "id": 3,
      ...
      "requirements": ["BUSN 2200 or 4400W", "CISC 1410 or 3130", "FINC 3377", "ECON 2200 or 3370 or 4422", "MATH 3601 or 4101 or 4501", "PHIL 3203 or 3204 or 3423", "POLS 3014W or 3421 or 3423", "PSYC 3510 or 3520 or 3530 or 3580 or 4400", "SOCY 3506 or 3604"],
      "prerequisites": ["If a student wishes to take a course from the list they must pass the prerequisites for that course"]
    }]
  }
};
var _default = prerequisiteData;
